...
public static partial class Util
{
	...
	public static Vector2 CanvasToWorld(this Canvas canvas, Camera camera, Vector3 canvas_position)
	{
		RectTransform canvas_rect = canvas.GetComponent<RectTransform>();
        canvas_position /= canvas_rect.sizeDelta;
        canvas_position.x += 0.5f;
        canvas_position.y += 0.5f;
        return camera.ViewportToWorldPoint(canvas_position);
	}
