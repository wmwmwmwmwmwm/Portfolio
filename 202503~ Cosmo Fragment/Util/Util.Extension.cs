...
public static partial class Util
{
	...
	public static void DestroyElement<T>(this ICollection<T> collection, T element) where T : Component
	{
		collection.Remove(element);
		Object.Destroy(element.gameObject);
	}

	public static void DestroyElements<T>(this ICollection<T> collection) where T : Component
	{
